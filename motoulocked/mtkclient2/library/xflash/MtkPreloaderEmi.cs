...
internal class MtkPreloaderEmi : IEquatable<MtkPreloaderEmi>
{
	...
	{
		return checked((EqualityComparer<Type>.Default.GetHashCode(EqualityContract) * -1521134295 + EqualityComparer<uint>.Default.GetHashCode(Version)) * -1521134295 + EqualityComparer<byte[]>.Default.GetHashCode(Emi));
	}
	...
	public  bool Equals(MtkPreloaderEmi other)
	{
		if ((object)this != other)
		{
			if ((object)other != null && (object)EqualityContract == other.EqualityContract && EqualityComparer<uint>.Default.Equals(Version, other.Version))
			{
