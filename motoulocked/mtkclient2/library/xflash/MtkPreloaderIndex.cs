...
internal class MtkPreloaderIndex : IEquatable<MtkPreloaderIndex>
{
	protected  Type EqualityContract
	{
		...
		get
		{
			return typeof(MtkPreloaderIndex);
		}
	}
	...
	{
		return checked((EqualityComparer<Type>.Default.GetHashCode(EqualityContract) * -1521134295 + EqualityComparer<int>.Default.GetHashCode(Index)) * -1521134295 + EqualityComparer<int>.Default.GetHashCode(Length));
	}
	...
	public  bool Equals(MtkPreloaderIndex other)
	{
		if ((object)this != other)
		{
			if ((object)other != null && (object)EqualityContract == other.EqualityContract && EqualityComparer<int>.Default.Equals(Index, other.Index))
			{
