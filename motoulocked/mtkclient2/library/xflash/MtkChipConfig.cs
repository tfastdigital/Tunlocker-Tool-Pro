...
internal class MtkChipConfig : IEquatable<MtkChipConfig>
{
	...
	public uint? meid_addr { get; set; }

	public uint? prov_addr { get; set; }

	public uint? socid_addr { get; set; }
	...
	{
		return checked((((((((((((EqualityComparer<Type>.Default.GetHashCode(EqualityContract) * -1521134295 + EqualityComparer<uint>.Default.GetHashCode(HardwareCode)) * -1521134295 + EqualityComparer<string>.Default.GetHashCode(Name)) * -1521134295 + EqualityComparer<uint>.Default.GetHashCode(DaCode)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(WdgAddress)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(PayloadAddress)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(UartAddress)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(PtrDl)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(PtrDa)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(Var1)) * -1521134295 + EqualityComparer<uint?>.Default.GetHashCode(SejBase)) * -1521134295 + EqualityComparer<string>.Default.GetHashCode(PayloadFileName)) * -1521134295 + EqualityComparer<bool>.Default.GetHashCode(UseXFlash));
	}
	...
	public  bool Equals(MtkChipConfig other)
	{
		if ((object)this != other)
		{
			if ((object)other != null && (object)EqualityContract == other.EqualityContract && EqualityComparer<uint>.Default.Equals(HardwareCode, other.HardwareCode) && EqualityComparer<string>.Default.Equals(Name, other.Name) && EqualityComparer<uint>.Default.Equals(DaCode, other.DaCode) && EqualityComparer<uint?>.Default.Equals(WdgAddress, other.WdgAddress) && EqualityComparer<uint?>.Default.Equals(PayloadAddress, other.PayloadAddress) && EqualityComparer<uint?>.Default.Equals(UartAddress, other.UartAddress) && EqualityComparer<uint?>.Default.Equals(PtrDl, other.PtrDl) && EqualityComparer<uint?>.Default.Equals(PtrDa, other.PtrDa) && EqualityComparer<uint?>.Default.Equals(Var1, other.Var1) && EqualityComparer<uint?>.Default.Equals(SejBase, other.SejBase) && EqualityComparer<string>.Default.Equals(PayloadFileName, other.PayloadFileName))
			{
