...
internal class MtkPreloader : IEquatable<MtkPreloader>
{
	...
	{
		return checked((((EqualityComparer<Type>.Default.GetHashCode(EqualityContract) * -1521134295 + EqualityComparer<string>.Default.GetHashCode(Name)) * -1521134295 + EqualityComparer<uint>.Default.GetHashCode(Version)) * -1521134295 + EqualityComparer<byte[]>.Default.GetHashCode(Emi)) * -1521134295 + EqualityComparer<byte[]>.Default.GetHashCode(Data));
	}
	...
	public  bool Equals(MtkPreloader other)
	{
		if ((object)this != other)
		{
			if ((object)other != null && (object)EqualityContract == other.EqualityContract && EqualityComparer<string>.Default.Equals(Name, other.Name) && EqualityComparer<uint>.Default.Equals(Version, other.Version) && EqualityComparer<byte[]>.Default.Equals(Emi, other.Emi))
			{
