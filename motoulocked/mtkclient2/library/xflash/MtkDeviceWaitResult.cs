...
internal class MtkDeviceWaitResult : IEquatable<MtkDeviceWaitResult>
{
	protected  Type EqualityContract
	{
		...
		get
		{
			return typeof(MtkDeviceWaitResult);
		}
	}
	...
	{
		return checked(((EqualityComparer<Type>.Default.GetHashCode(EqualityContract) * -1521134295 + EqualityComparer<IMtkDevice>.Default.GetHashCode(Device)) * -1521134295 + EqualityComparer<bool>.Default.GetHashCode(IsBootloader)) * -1521134295 + EqualityComparer<MtkDeviceInfo>.Default.GetHashCode(DeviceInfo));
	}
	...
	public  bool Equals(MtkDeviceWaitResult other)
	{
		if ((object)this != other)
		{
			if ((object)other != null && (object)EqualityContract == other.EqualityContract && EqualityComparer<IMtkDevice>.Default.Equals(Device, other.Device) && EqualityComparer<bool>.Default.Equals(IsBootloader, other.IsBootloader))
			{
				return EqualityComparer<MtkDeviceInfo>.Default.Equals(DeviceInfo, other.DeviceInfo);
			}
			return false;
		}
		return true;
	...
	public  MtkDeviceWaitResult _get()
	{
	...
	public void Deconstruct(out IMtkDevice Device, out bool IsBootloader, out MtkDeviceInfo DeviceInfo)
	{
		Device = this.Device;
