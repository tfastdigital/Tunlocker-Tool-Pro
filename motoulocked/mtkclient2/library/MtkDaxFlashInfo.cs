...
internal class MtkDaxFlashInfo 
{
	...
	public  bool Equals(MtkDaxFlashInfo other)
	{
		if ((object)this != other)
		{
			if ((object)other != null && (object)EqualityContract == other.EqualityContract && EqualityComparer<MtkDaxFlashInfoType>.Default.Equals(Type, other.Type) && EqualityComparer<long[]>.Default.Equals(FlashSizes, other.FlashSizes) && EqualityComparer<long>.Default.Equals(RpmbSize, other.RpmbSize) && EqualityComparer<long>.Default.Equals(Boot1Size, other.Boot1Size) && EqualityComparer<long>.Default.Equals(Boot2Size, other.Boot2Size) && EqualityComparer<int>.Default.Equals(PageSize, other.PageSize) && EqualityComparer<int>.Default.Equals(WriteBufferSize, other.WriteBufferSize))
			{
				return EqualityComparer<int>.Default.Equals(ReadBufferSize, other.ReadBufferSize);
			}
			return false;
		}
		return true;
